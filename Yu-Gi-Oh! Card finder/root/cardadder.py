...
# Q15 = "SELECT * FROM Cards "#Select the card type column related to the name user inputted
...
# search_card = input("Please enter in a card name")
# name = [search_card]#places user input into an array

# Q15 = "SELECT * FROM Cards "#Select the card type column related to the name user inputted
# mycursor.execute(Q15)#Excutes the query using name as a parameter
